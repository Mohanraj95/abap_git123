  ...
  METHOD update.
   DATA legacy_entity_in   TYPE /dmo/travel.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zsrap_travel_x_2045( <entity> MAPPING FROM ENTITY ).
...
CLASS lsc_ZI_RAP_TRAVEL_U_2045 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZI_RAP_TRAVEL_U_2045 IMPLEMENTATION.
