CLASS zcl_ce_rap_agency_2026 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF zsc_rap_agency_2026=>tys_z_travel_agency_es_5_type-agency_id.
    TYPES t_business_data TYPE TABLE OF zsc_rap_agency_2026=>tys_z_travel_agency_es_5_type.
...
CLASS zcl_ce_rap_agency_2026 IMPLEMENTATION.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZSC_RAP_AGENCY_2026' ).

    odata_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
      EXPORTING
      is_proxy_model_key       = VALUE #( repository_id       = 'DEFAULT'
                                              proxy_model_id      = 'ZSC_RAP_AGENCY_2026'
