...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_features.
   " Read the travel status of the existing travels
    READ ENTITIES OF zi_rap_travel_2026 IN LOCAL MODE
      ENTITY Travel
  ...
  METHOD acceptTravel.
    ...
    MODIFY ENTITIES OF zi_rap_travel_2026 IN LOCAL MODE
      ENTITY Travel
         UPDATE
           FIELDS ( TravelStatus )
...
*    ENDIF.
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      APPEND VALUE #(  %tky               = travel-%tky
        ...
        TO reported-travel.
    ENDLOOP.
   DATA business_data TYPE TABLE OF zsc_rap_agency_2026=>tys_z_travel_agency_es_5_type.
...
**      IF travel-AgencyID IS INITIAL OR NOT line_exists( agencies_db[ agency_id = travel-AgencyID ] ).
      IF travel-AgencyID IS INITIAL OR NOT line_exists( business_data[ agency_id = travel-AgencyID ] ).
        ...
        APPEND VALUE #( %tky        = travel-%tky
                        %state_area = 'VALIDATE_AGENCY'
                        %msg        = NEW zcm_rap_2026(
                                          severity = if_abap_behv_message=>severity-error
                                          textid   = zcm_rap_2026=>agency_unknown
...
*        TO reported-travel.
      ...
      IF travel-CustomerID IS INITIAL OR NOT line_exists( customers_db[ customer_id = travel-CustomerID ] ).
        ...
        APPEND VALUE #( %tky        = travel-%tky
                        ...
                        %msg        = NEW zcm_rap_2026(
                                          severity = if_abap_behv_message=>severity-error
                                          textid   = zcm_rap_2026=>customer_unknown
                                          agencyid = travel-AgencyID )
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-EndDate < travel-BeginDate.
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_2026(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zcm_rap_2026=>date_interval
      ...
      ELSEIF travel-BeginDate < cl_abap_context_info=>get_system_date( ).
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_2026(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zcm_rap_2026=>begin_date_before_system_date
                                                 begindate = travel-BeginDate )
       ...
       IF is_update_requested = abap_true.
         ...
         IF has_before_image = abap_true.
           ...
           IF update_granted = abap_false.
             APPEND VALUE #( %tky        = travel-%tky
                             %msg        = NEW zcm_rap_2026( severity = if_abap_behv_message=>severity-error
                                                             textid   = zcm_rap_2026=>unauthorized )
                           ) TO reported-travel.
           ENDIF.
  ...
  METHOD is_create_granted.
    ...
    AUTHORITY-CHECK OBJECT 'ZOSTAT2026'
      ID 'ZOSTAT2026' DUMMY
      ID 'ACTVT' FIELD '01'.
  ...
  METHOD is_delete_granted.
    IF has_before_image = abap_true.
      AUTHORITY-CHECK OBJECT 'ZOSTAT2026'
        ID 'ZOSTAT2026' FIELD overall_status
        ID 'ACTVT' FIELD '06'.
    ELSE.
      AUTHORITY-CHECK OBJECT 'ZOSTAT2026'
        ID 'ZOSTAT2026' DUMMY
